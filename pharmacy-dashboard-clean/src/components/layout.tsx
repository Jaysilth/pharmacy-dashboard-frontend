...
import {
  ...
  LayoutDashboard, LogOut, User, Users,
} from "lucide-react";
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  // Users nav item only visible to SUPER_ADMIN
    ...
    <div className="flex min-h-screen w-full bg-background">
      ...
      <aside className="w-64 flex-col hidden md:flex border-r bg-sidebar">
        ...
        <div className="px-4 py-4 border-t border-sidebar-border space-y-2">
          {/* Profile card — shows real username and role */}
          <div className="flex items-center px-3 py-2 mb-1 rounded-md bg-muted/50 border border-border">
